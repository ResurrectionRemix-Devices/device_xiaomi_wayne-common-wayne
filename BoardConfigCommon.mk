...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := $(WAYNE_COMMON_PATH)/bluetooth
...
# Init
TARGET_INIT_VENDOR_LIB := //$(WAYNE_COMMON_PATH):libinit_sdm660
...
BOARD_SEPOLICY_DIRS += $(WAYNE_COMMON_PATH)/sepolicy/vendor
BOARD_PLAT_PUBLIC_SEPOLICY_DIR += $(WAYNE_COMMON_PATH)/sepolicy/public
BOARD_PLAT_PRIVATE_SEPOLICY_DIR += $(WAYNE_COMMON_PATH)/sepolicy/private
